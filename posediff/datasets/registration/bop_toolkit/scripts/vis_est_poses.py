...
p = {
  ...
  'result_filenames': [
    '/home/ubuntu/hjw/code/Ref-GeoTransformer/output/geotransformer.modelnet.rpmnet.stage4.gse.k3.max.oacl.stage2.sinkhorn/result/csv/E-cordi-foldnet-cls-pbr-lm-res-t-ortho6d-add-k16-400steps-mh-1000050-icp_lmo-test.csv',
  ],
